...
$q_get_user_info = "SELECT first_name, last_name, Usergroup, Avatar 
					FROM user
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					<?
					$Month = date('F Y');
                    echo'<h2>Projects Sold - ' . $Month . '</h2>';
					?>
				  ...
				  <?php
				  $Q_Get_Projects = "SELECT project_ID, project_name, CONCAT(SUBSTRING(DateSigned,1,10)) AS DateSigned, Project_Cost, 
					CONCAT(c.first_name, ' ', c.last_name) AS Salesperson, project_status
					FROM project p
                      ...
                      <table class="table table-striped jambo_table">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Date Signed </th>
                            <th class="column-title">Project Cost </th>
                            <th class="column-title">Salesperson </th>
                        ...
                        <tbody>
						 <?php
						 while($row = $R_Get_Projects->fetch_array(MYSQLI_ASSOC)){
                          echo'<tr>
                            <td>'.$row['project_name'].'</td>
                            <td>'.$row['DateSigned'].'</td>
                            <td>'.$row['Project_Cost'].'</td>
                            <td>'.$row['Salesperson'].'</td>
                            <td class=" last"><a href="Edit_Project.php?proj_id='.$row['project_ID'].'">View</a>
                            </td>
                          </tr>';
						  }
						  ?>
