...
//Dealing with Program ID's
if ( (isset($_GET['Program_ID']))  && (is_numeric($_GET['Program_ID'])) ) {
	$Program_ID = $_GET['Program_ID'];
}
else if ( (isset($_POST['Program_ID'])) && (is_numeric($_POST['Program_ID'])) ) { //data being passed via form submission
	$Program_ID = $_POST['Program_ID'];
}
else { //an invalid Program ID was provided, kill script
//No reason to pass an additional error here, since the query won't work without the $Program_ID variable
}
$Q_Program_Info = "SELECT description, short_desc 
					FROM energy_program
                    WHERE program_id = $Program_ID";
$R_Program_Info = $mysqli->query($Q_Program_Info);
$ProgramInfo = $R_Program_Info->fetch_array(MYSQLI_NUM);
